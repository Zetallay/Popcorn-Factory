...
import kotlinx.android.synthetic.main.cell_serie.view.*
...
class CatalogActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cargarSeries()
        serie_catalog.adapter = adapter2
    ...
    fun cargarPeliculas(){
        ...
        peliculas.add(Pelicula("Men in Black",R.drawable.mib, R.drawable.mibheader, "Traveling across time and space, the immortal time-lord known as 'The Doctor' travels across the universe with his many companions and his loyal shape-shifting space-ship: The TARDIS. The Doctor faces many threats across many generations: from The Daleks, The Cybermen and his time-lord adversary The Master to the sinister Davros, creator of The Daleks."))
    ...
    fun cargarSeries(){
        ...
        series.add(Serie("Suits", R.drawable.suits, R.drawable.suitsheader,""))
        series.add(Serie("Firends",R.drawable.friends, R.drawable.friendsheader,""))
    ...
    class SerieAdapter: BaseAdapter{
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var vista = inflator.inflate(R.layout.cell_serie, null)
            vista.image_serie_cell.setImageResource(serie.image)
            vista.serie_title_cell.setText(serie.titulo)

            vista.image_serie_cell.setOnClickListener{
